...
public class Tabla {
     ...
     */
    public Tabla(MainActivity actividad, TableLayout tabla)
    {
    ...
    public void agregarCabecera(int recursocabecera)
    {
        ...
        for(int i = 0; i < arraycabecera.length; i++)
        {
            ...
            texto.setTextAppearance(actividad, R.style.letra_titulos);
            texto.setBackgroundResource(R.drawable.borde_todos_gris);
    ...
    public void agregarFilaTabla(ArrayList<String> elementos)
    {
        ...
        for(int i = 0; i< elementos.size(); i++)
        {
            ...
            texto.setGravity(Gravity.CENTER_HORIZONTAL);
            texto.setTextAppearance(actividad, R.style.letra_contenido);
            texto.setBackgroundResource(R.drawable.borde_todos_gris);
