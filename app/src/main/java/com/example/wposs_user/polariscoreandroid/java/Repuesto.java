...
public class Repuesto {
    ...
    private String spar_id,spar_code,spar_date_register,spar_name,spar_register_by,spar_status,spar_status_temporal,spar_terminal_model,spar_warehouse;
    private String spar_quantity;
